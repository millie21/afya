...
public class SimpleDrugs  extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<Stock> salesList;

    public SimpleDrugs(Activity activity, List<Stock> salesList){
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if( view == null)
            view = inflater.inflate(R.layout.list_cat_drug,null);
