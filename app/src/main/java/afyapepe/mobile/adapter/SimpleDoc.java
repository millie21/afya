...
public class SimpleDoc extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<Stock> salesListd;

    public SimpleDoc(Activity activity, List<Stock> salesListd){
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if( view == null)
            view = inflater.inflate(R.layout.list_cat_doc,null);
...
//        TextView Quantity = (TextView)view.findViewById(R.id.tv);
        TextView Docid = (TextView)view.findViewById(R.id.tv);
