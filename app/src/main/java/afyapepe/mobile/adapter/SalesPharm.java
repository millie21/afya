...
public class SalesPharm extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<Stock> salesList;

    public SalesPharm(Activity activity, List<Stock> salesList){
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if( view == null)
            view = inflater.inflate(R.layout.list_cat_pharm,null);
...
//        TextView County = (TextView)view.findViewById(R.id.tvname2);
      //  TextView Pharmid = (TextView)view.findViewById(R.id.tvposition0);
...
//        Pharmid.setText(stock.getPharmid());
