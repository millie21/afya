...
public class ManuTrendMonthR extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.191/afyapepe3/public/showmanutrendsregionmonth?email=manu1@afyapepe.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manu_trend_month_r);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        builder = new AlertDialog.Builder(ManuTrendMonthR.this);
...
//                                "totalq": "90"
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    ManuTrendMonthR.this, allemployeeslist,
