...
public class CountyFortySeven extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(CountyFortySeven.this);

        session = new SessionManager(CountyFortySeven.this);
        ...
        adapter = new SimpleSalesAdapterR(CountyFortySeven.this, salesListr);
        listView.setAdapter(adapter);

        //      adapterRTotal = new SalesAdapterRTotal(ManuByRegion.this, totalsaleslist);
//        listViewcash.setAdapter(adapterRTotal);

        pDialog = new ProgressDialog(CountyFortySeven.this);

        pDialog.setMessage("Loading...");
        pDialog.setCancelable(false);
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.county_47,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(CountyFortySeven.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                       getTotalCash.setText(""+testtotal);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(CountyFortySeven.this, error.toString(), Toast.LENGTH_LONG).show();
