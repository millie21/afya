...
public class CountyEighteen extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(CountyEighteen.this);

        session = new SessionManager(CountyEighteen.this);
        ...
        adapter = new SimpleSalesAdapterR(CountyEighteen.this, salesListr);
        listView.setAdapter(adapter);

        //      adapterRTotal = new SalesAdapterRTotal(ManuByRegion.this, totalsaleslist);
//        listViewcash.setAdapter(adapterRTotal);

        pDialog = new ProgressDialog(CountyEighteen.this);

        pDialog.setMessage("Loading...");
        pDialog.setCancelable(false);
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.county_18,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(CountyEighteen.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                       getTotalCash.setText(""+testtotal);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(CountyEighteen.this, error.toString(), Toast.LENGTH_LONG).show();
