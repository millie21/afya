...
public class SubMaxFT extends AppCompatActivity {
  ...
  ListView TaskListView;
    ...
    private static String url = "http://192.168.2.196/afyapepe3/public/showmanudrugsubstitutionsinmax?email=manu1@afyapepe.com&id=9";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(SubMaxFT.this);

        session = new SessionManager(SubMaxFT.this);
...
//       TextView count = (TextView) findViewById(R.id.testing12);
        ...
        adapter = new SimpleSubAAdapter(SubMaxFT.this, subList);



        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(SubMaxFT.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(SubMaxFT.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SubMaxFT.this, error.toString(), Toast.LENGTH_LONG).show();
