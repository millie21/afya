...
import afyapepe.mobile.adapter.ManuCompeSalesAdapterW;
...
public class ManuCompeSalesWeekly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(ManuCompeSalesWeekly.this);

        session = new SessionManager(ManuCompeSalesWeekly.this);
        ...
        adapter = new SimpleCompeSalesAdapter(ManuCompeSalesWeekly.this, sectorList);
        ...
        pDialog = new ProgressDialog(ManuCompeSalesWeekly.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.company1w_url,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ManuCompeSalesWeekly.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ManuCompeSalesWeekly.this, error.toString(), Toast.LENGTH_LONG).show();
...
//        stringRequest.add(request);
        ...
        //company2
        StringRequest stringRequest2 = new StringRequest(Request.Method.POST, App_Config.company2w_url,
...
//        stringRequest.add(request);
        ...
        //company3
        StringRequest stringRequest3 = new StringRequest(Request.Method.POST, App_Config.company3w_url,
        ...
        //company4
        StringRequest stringRequest4 = new StringRequest(Request.Method.POST, App_Config.company4w_url,
        ...
        //company5
        StringRequest stringRequest5 = new StringRequest(Request.Method.POST, App_Config.company6w_url,
...
//        ManuCompeSalesAdapterW vadapter = new ManuCompeSalesAdapterW(this, getSupportFragmentManager());
//
