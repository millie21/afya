...
public class SubTodayAway extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_today_away);
        ...
        session = new SessionManager(SubTodayAway.this);
...
//       TextView count = (TextView) findViewById(R.id.testing12);
        ...
        adapter = new SimpleSubAAdapter(SubTodayAway.this, subList);


        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(SubTodayAway.this);
