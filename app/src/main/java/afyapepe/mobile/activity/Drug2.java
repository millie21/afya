...
public class Drug2 extends AppCompatActivity {
    ...
    public  void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(Drug2.this);

        session = new SessionManager(Drug2.this);
        ...
        adapter = new SimpleSalesAdapter(Drug2.this, salesList);
        listView.setAdapter(adapter);

        pDialog = new ProgressDialog(Drug2.this);

        pDialog.setMessage("Loading...");
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.drug2_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(Drug2.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                                * and any View reflecting the data set should refresh itself.
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Drug2.this, error.toString(), Toast.LENGTH_LONG).show();
