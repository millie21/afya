...
public class MAnuTrendWeekCo extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.196/afyapepe3/public/showmanutrendscompanysweek?email=manu1@afyapepe.com&id=9";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(MAnuTrendWeekCo.this);

        session = new SessionManager(MAnuTrendWeekCo.this);
...
//       TextView count = (TextView) findViewById(R.id.testing12);
        ...
        adapter = new SimpleTrendsAdapter(MAnuTrendWeekCo.this, trendsList);



        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(MAnuTrendWeekCo.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(MAnuTrendWeekCo.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MAnuTrendWeekCo.this, error.toString(), Toast.LENGTH_LONG).show();
