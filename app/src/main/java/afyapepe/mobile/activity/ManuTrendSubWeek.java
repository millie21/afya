...
public class ManuTrendSubWeek  extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.191/afyapepe3/public/showmanutrendssubstitutionweek?email=manu1@afyapepe.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(ManuTrendSubWeek.this);
...
//                                "totalq": "90"
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    ManuTrendSubWeek.this, allemployeeslist,
