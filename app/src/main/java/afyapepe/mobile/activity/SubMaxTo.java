...
public class SubMaxTo extends AppCompatActivity {
   ...
   ListView TaskListView;
    ...
    private static String url = "http://192.168.2.196/afyapepe3/public/showmanudrugsubstitutionstomax?email=manu1@afyapepe.com&id=9";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(SubMaxTo.this);

        session = new SessionManager(SubMaxTo.this);
...
//       TextView count = (TextView) findViewById(R.id.testing12);
        ...
        adapter = new SimpleSubAAdapter(SubMaxTo.this, subList);



        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(SubMaxTo.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(SubMaxTo.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SubMaxTo.this, error.toString(), Toast.LENGTH_LONG).show();
