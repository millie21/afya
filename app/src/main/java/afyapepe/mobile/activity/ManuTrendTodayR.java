...
import afyapepe.mobile.adapter.SimpleRegionTrendsAdapter;
...
public class ManuTrendTodayR extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.196/afyapepe3/public/showmanutrendsregiontoday?email=manu1@afyapepe.com&id=9";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(ManuTrendTodayR.this);

        session = new SessionManager(ManuTrendTodayR.this);
...
//       TextView count = (TextView) findViewById(R.id.testing12);
        ...
        adapter = new SimpleRegionTrendsAdapter(ManuTrendTodayR.this, trendsListr);


        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(ManuTrendTodayR.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ManuTrendTodayR.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ManuTrendTodayR.this, error.toString(), Toast.LENGTH_LONG).show();
