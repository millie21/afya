...
public class ManuTrendTodayR extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.191/afyapepe3/public/showmanutrendsregiontoday?email=manu1@afyapepe.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manu_trend_sub_today);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        builder = new AlertDialog.Builder(ManuTrendTodayR.this);
...
//                                "totalq": "90"
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    ManuTrendTodayR.this, allemployeeslist,

                    R.layout.list_trend_r, new String[]{"county","totalq"},
