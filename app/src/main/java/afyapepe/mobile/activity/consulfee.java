...
public class consulfee extends AppCompatActivity {
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(consulfee.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://afyapepe.com/afyapepe/join_test.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for(int i=0;i<jArray.length();i++){
                    ...
                    fishData.sizeName= json_data.getString("amount");
                ...
                mAdapter = new AdapterFishu(consulfee.this, data);
                mRVFishPrice.setLayoutManager(new LinearLayoutManager(consulfee.this));

                mRVFishPrice.setAdapter(mAdapter);

            } catch (JSONException e) {
                Toast.makeText(consulfee.this, e.toString(), Toast.LENGTH_LONG).show();
            }
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(consulfee.this, LoginActivity.class);
