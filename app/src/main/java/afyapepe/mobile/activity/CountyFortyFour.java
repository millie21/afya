...
public class CountyFortyFour extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(CountyFortyFour.this);

        session = new SessionManager(CountyFortyFour.this);
        ...
        adapter = new SimpleSalesAdapterR(CountyFortyFour.this, salesListr);
        listView.setAdapter(adapter);

        //      adapterRTotal = new SalesAdapterRTotal(ManuByRegion.this, totalsaleslist);
//        listViewcash.setAdapter(adapterRTotal);

        pDialog = new ProgressDialog(CountyFortyFour.this);

        pDialog.setMessage("Loading...");
        pDialog.setCancelable(false);
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.county_44,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(CountyFortyFour.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                       getTotalCash.setText(""+testtotal);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(CountyFortyFour.this, error.toString(), Toast.LENGTH_LONG).show();
