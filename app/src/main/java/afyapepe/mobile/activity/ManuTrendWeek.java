...
public class ManuTrendWeek extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.196/afyapepe3/public/showmanutrendscompanyweek?email=manu1@afyapepe.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(ManuTrendWeek.this);

        session = new SessionManager(ManuTrendWeek.this);
...
//       TextView count = (TextView) findViewById(R.id.testing12);
        ...
        adapter = new SimpleTrendsAdapter(ManuTrendWeek.this, trendsList);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ManuTrendWeek.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ManuTrendWeek.this, error.toString(), Toast.LENGTH_LONG).show();
