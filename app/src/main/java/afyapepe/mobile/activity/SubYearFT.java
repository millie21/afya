...
public class SubYearFT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(SubYearFT.this);

        session = new SessionManager(SubYearFT.this);
        ...
        pDialog = new ProgressDialog(SubYearFT.this);
...
//                                jsonObject = request.getJSONObject(i);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SubYearFT.this, error.toString(), Toast.LENGTH_LONG).show();
