...
public class ManuTrendToday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(ManuTrendToday.this);

        session = new SessionManager(ManuTrendToday.this);
        ...
        adapter = new SimpleTrendsAdapter(ManuTrendToday.this, trendsList);

        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(ManuTrendToday.this);
        pDialog.setMessage("Please wait...");
        pDialog.setCancelable(false);
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.manutrendtoday_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ManuTrendToday.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ManuTrendToday.this, error.toString(), Toast.LENGTH_LONG).show();
