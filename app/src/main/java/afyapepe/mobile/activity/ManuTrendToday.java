...
public class ManuTrendToday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manu_trend_today);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        builder = new AlertDialog.Builder(ManuTrendToday.this);
        allemployeeslist = new ArrayList<>();
        lv = (ListView)findViewById(R.id.listview11);


        new ManuTrendToday.GetAllJobs().execute();
    }
    ...
    private class GetAllJobs extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    ManuTrendToday.this, allemployeeslist,
