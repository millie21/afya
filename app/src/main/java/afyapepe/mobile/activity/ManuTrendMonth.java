...
public class ManuTrendMonth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manu_trend_month);
        ...
        db = new SQLiteHandler(ManuTrendMonth.this);

        session = new SessionManager(ManuTrendMonth.this);
        ...
        adapter = new SimpleTrendsAdapter(ManuTrendMonth.this, trendsList);


        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(ManuTrendMonth.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.manutrendmonth_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ManuTrendMonth.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ManuTrendMonth.this, error.toString(), Toast.LENGTH_LONG).show();
