...
public class Drug4 extends AppCompatActivity {
  ...
  //  private static String url = "http://192.168.0.49/afyapepe3/public/showmanusalesdrug4?email=manu1@afyapepe.com&id=9";
    ...
    public  void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(Drug4.this);

        session = new SessionManager(Drug4.this);
        ...
        adapter = new SimpleSalesAdapter(Drug4.this, salesList);
        listView.setAdapter(adapter);

        pDialog = new ProgressDialog(Drug4.this);

        pDialog.setMessage("Loading...");
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.drug4_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(Drug4.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                                * and any View reflecting the data set should refresh itself.
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Drug4.this, error.toString(), Toast.LENGTH_LONG).show();
