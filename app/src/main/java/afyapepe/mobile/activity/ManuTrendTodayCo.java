...
public class ManuTrendTodayCo extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.191/afyapepe3/public/showmanutrendscompanystoday?email=manu1@afyapepe.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manu_trend_today_co);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        builder = new AlertDialog.Builder(ManuTrendTodayCo.this);
        allemployeeslist = new ArrayList<>();
        lv = (ListView)findViewById(R.id.listview11);


        new ManuTrendTodayCo.GetAllJobs().execute();
    }
    ...
    private class GetAllJobs extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    ManuTrendTodayCo.this, allemployeeslist,
