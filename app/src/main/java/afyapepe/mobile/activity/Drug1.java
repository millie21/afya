...
public class Drug1 extends AppCompatActivity {
    ...
    public  void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(Drug1.this);

        session = new SessionManager(Drug1.this);
        ...
        adapter = new SimpleSalesAdapter(Drug1.this, salesList);
        listView.setAdapter(adapter);

        pDialog = new ProgressDialog(Drug1.this);

        pDialog.setMessage("Loading...");
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.drug1_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(Drug1.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                                * and any View reflecting the data set should refresh itself.
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Drug1.this, error.toString(), Toast.LENGTH_LONG).show();
