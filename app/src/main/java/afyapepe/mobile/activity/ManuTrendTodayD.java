...
import afyapepe.mobile.adapter.SimpleDrugTrendsAdapter;
...
public class ManuTrendTodayD extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.196/afyapepe3/public/showmanutrendsdrugtoday?email=manu1@afyapepe.com&id=9";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(ManuTrendTodayD.this);

        session = new SessionManager(ManuTrendTodayD.this);
...
//       TextView count = (TextView) findViewById(R.id.testing12);
        ...
        adapter = new SimpleDrugTrendsAdapter(ManuTrendTodayD.this, trendsListd);


        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(ManuTrendTodayD.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < request.length(); i++) {
                                ...
                                trendsListd.add(stock);
                            }

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(ManuTrendTodayD.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ManuTrendTodayD.this, error.toString(), Toast.LENGTH_LONG).show();
...
//                }
    ...
    public List<Stock> filteredDrugs(CharSequence charSequence){
        ...
        if (charString.isEmpty()){
            filteredstocklist = trendsListd;
        }
        else {
            ArrayList<Stock> filteredList = new ArrayList<>();

            for (Stock stock : trendsListd){
        ...
        trendsListd.addAll(filteredstocklist);
