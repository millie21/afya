...
import afyapepe.mobile.adapter.ManuCompeSalesAdapterY;
...
public class ManuCompeSalesYearly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SimpleCompeSalesAdapter(this, sectorList);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.company1y_url,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ManuCompeSalesYearly.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ManuCompeSalesYearly.this, error.toString(), Toast.LENGTH_LONG).show();
...

        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                db = new SQLiteHandler(ManuCompeSalesYearly.this);
        ...
        //company2
        StringRequest stringRequest2 = new StringRequest(Request.Method.POST, App_Config.company2y_url,
        ...
        //company3
        StringRequest stringRequest3 = new StringRequest(Request.Method.POST, App_Config.company3y_url,
        ...
        //company4
        StringRequest stringRequest4 = new StringRequest(Request.Method.POST, App_Config.company4y_url,
        ...
        //company5
        StringRequest stringRequest5 = new StringRequest(Request.Method.POST, App_Config.company6y_url,
...
//        ManuCompeSalesAdapterY vadapter = new ManuCompeSalesAdapterY(this, getSupportFragmentManager());
//
