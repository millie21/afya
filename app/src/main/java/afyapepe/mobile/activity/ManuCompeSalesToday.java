...
public class ManuCompeSalesToday extends AppCompatActivity {
    ...
    private List<Stock> sectorList2 = new ArrayList<Stock>();
    private List<Stock> sectorList3 = new ArrayList<Stock>();
    private List<Stock> sectorList4 = new ArrayList<Stock>();
    private List<Stock> sectorList5 = new ArrayList<Stock>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(ManuCompeSalesToday.this);

        session = new SessionManager(ManuCompeSalesToday.this);
        ...
        //maybe set oops message in bottom sheet drawer?


        fab = (FloatingActionButton) findViewById(R.id.fab);

        adapter = new SimpleCompeSalesAdapter(ManuCompeSalesToday.this, sectorList);
        adapter2 = new SimpleCompeSalesAdapter2(ManuCompeSalesToday.this,sectorList2);
        adapter3 = new SimpleCompeSalesAdapter3(ManuCompeSalesToday.this,sectorList3);
        adapter4 = new SimpleCompeSalesAdapter4(ManuCompeSalesToday.this,sectorList4);
        adapter5 = new SimpleCompeSalesAdapter5(ManuCompeSalesToday.this,sectorList5);
        ...
        pDialog = new ProgressDialog(ManuCompeSalesToday.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.company1_url,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ManuCompeSalesToday.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ManuCompeSalesToday.this, error.toString(), Toast.LENGTH_LONG).show();
...
//        stringRequest.add(request);
       ...
       //company2
        StringRequest stringRequest2 = new StringRequest(Request.Method.POST, App_Config.company2_url,
...
//        stringRequest.add(request);
        ...
        //company3
        StringRequest stringRequest3 = new StringRequest(Request.Method.POST, App_Config.company3_url,
        ...
        //company4
        StringRequest stringRequest4 = new StringRequest(Request.Method.POST, App_Config.company4_url,
        ...
        //company5
        StringRequest stringRequest5 = new StringRequest(Request.Method.POST, App_Config.company5_url,
