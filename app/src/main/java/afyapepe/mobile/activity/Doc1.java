...
public class Doc1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(Doc1.this);

        session = new SessionManager(Doc1.this);
        ...
        adapter = new SimpleSalesAdapterD(Doc1.this, salesListd);
        regdapter = new RegionDocTotal(Doc1.this, regionDocTotal);
        listView.setAdapter(adapter);
        list2.setAdapter(regdapter);

        pDialog = new ProgressDialog(Doc1.this);

        pDialog.setMessage("Loading...");
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.doc1_sale_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(Doc1.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                        getTotalCount.setText(""+listView.getCount());
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Doc1.this, error.toString(), Toast.LENGTH_LONG).show();
        ...
        StringRequest stringRequest2 = new StringRequest(Request.Method.POST, App_Config.doc1_sales_tots,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d(TAG, response.toString());
