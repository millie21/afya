...
public class SubTodayTo extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.196/afyapepe3/public/showmanudrugsubstitutionstotoday?email=manu1@afyapepe.com&id=9";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(SubTodayTo.this);

        session = new SessionManager(SubTodayTo.this);
...
//       TextView count = (TextView) findViewById(R.id.testing12);
        ...
        adapter = new SimpleSubAAdapter(SubTodayTo.this, subList);


        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(SubTodayTo.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(SubTodayTo.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SubTodayTo.this, error.toString(), Toast.LENGTH_LONG).show();
