...
public class CountyOne extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(CountyOne.this);

        session = new SessionManager(CountyOne.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(CountyOne.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                                * and any View reflecting the data set should refresh itself.
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(CountyOne.this, error.toString(), Toast.LENGTH_LONG).show();
