...
public class Sector_Drug extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_sector_activity, container, false);
        return rootView;

    }

    private static String url = "http://192.168.2.193/afyapepe3/public/showmanusectorsummary?email=manu1@afyapepe.com";
    ...
    private class GetAllJobs extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(getActivity().getApplicationContext(),
                    ...
                    R.layout.list_sector_d, new String[]{"drugname", "name", "id", "total"},
