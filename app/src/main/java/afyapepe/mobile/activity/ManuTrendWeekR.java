...
public class ManuTrendWeekR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(ManuTrendWeekR.this);

        session = new SessionManager(ManuTrendWeekR.this);
        ...
        adapter = new SimpleRegionTrendsAdapter(ManuTrendWeekR.this, trendsListr);


        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(ManuTrendWeekR.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ManuTrendWeekR.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
...
//                        getTotalCount.setText(""+TaskListView.getCount());
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ManuTrendWeekR.this, error.toString(), Toast.LENGTH_LONG).show();
