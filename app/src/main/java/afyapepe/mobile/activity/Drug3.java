...
public class Drug3 extends AppCompatActivity {
   ...
   // private static String url = "http://192.168.0.49/afyapepe3/public/showmanusalesdrug1?email=manu1@afyapepe.com&id=9";
    ...
    public  void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(Drug3.this);

        session = new SessionManager(Drug3.this);
        ...
        adapter = new SimpleSalesAdapter(Drug3.this, salesList);
        listView.setAdapter(adapter);

        pDialog = new ProgressDialog(Drug3.this);

        pDialog.setMessage("Loading...");
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.drug3_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(Drug3.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                                * and any View reflecting the data set should refresh itself.
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Drug3.this, error.toString(), Toast.LENGTH_LONG).show();
