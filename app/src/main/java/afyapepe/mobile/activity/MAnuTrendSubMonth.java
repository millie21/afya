...
public class MAnuTrendSubMonth extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.193/afyapepe3/public/showmanutrendssubstitutionmonth?email=manu1@afyapepe.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(MAnuTrendSubMonth.this);
...
//                                "totalq": "90"
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    MAnuTrendSubMonth.this, allemployeeslist,
