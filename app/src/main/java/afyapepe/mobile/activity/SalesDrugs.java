...
import afyapepe.mobile.activity.SalesDrugs;
...
public class SalesDrugs extends AppCompatActivity {

    private List<Stock> salesList = new ArrayList<Stock>();
    private ListView listView;
    private SimpleDrugs adapter;
    ...
    public  void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mau_presc);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        db = new SQLiteHandler(SalesDrugs.this);

        session = new SessionManager(SalesDrugs.this);
        ...
        adapter = new SimpleDrugs(SalesDrugs.this, salesList);
        listView.setAdapter(adapter);

        pDialog = new ProgressDialog(SalesDrugs.this);

        pDialog.setMessage("Loading...");
        pDialog.setCancelable(false);
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.sales_drugs_url,
...
//                                stock.setTotal(jsonObject.getString("total"));
                            ...
                            e.printStackTrace();
                            Toast.makeText(SalesDrugs.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                                * and any View reflecting the data set should refresh itself.
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SalesDrugs.this, error.toString(), Toast.LENGTH_LONG).show();
...
//
//                Intent newrules = new Intent(SalesDrugs.this,ManuByDrug.class);
//
