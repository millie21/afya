...
public class SubWeekAway extends AppCompatActivity {
    ...
    private static String url = "http://192.168.2.196/afyapepe3/public/showmanudrugsubstitutionsawayweek?email=manu1@afyapepe.com&id=9";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_week_away);
        ...
        db = new SQLiteHandler(SubWeekAway.this);

        session = new SessionManager(SubWeekAway.this);
...
//       TextView count = (TextView) findViewById(R.id.testing12);
        ...
        adapter = new SimpleSubAAdapter(SubWeekAway.this, subList);


        TaskListView.setAdapter(adapter);
        // Showing progress dialog
        pDialog = new ProgressDialog(SubWeekAway.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(SubWeekAway.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SubWeekAway.this, error.toString(), Toast.LENGTH_LONG).show();
