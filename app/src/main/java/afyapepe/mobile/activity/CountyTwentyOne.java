...
public class CountyTwentyOne extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(CountyTwentyOne.this);

        session = new SessionManager(CountyTwentyOne.this);
        ...
        adapter = new SimpleSalesAdapterR(CountyTwentyOne.this, salesListr);
        listView.setAdapter(adapter);

        //      adapterRTotal = new SalesAdapterRTotal(ManuByRegion.this, totalsaleslist);
//        listViewcash.setAdapter(adapterRTotal);

        pDialog = new ProgressDialog(CountyTwentyOne.this);

        pDialog.setMessage("Loading...");
        pDialog.setCancelable(false);
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.county_21,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(CountyTwentyOne.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                       getTotalCash.setText(""+testtotal);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(CountyTwentyOne.this, error.toString(), Toast.LENGTH_LONG).show();
