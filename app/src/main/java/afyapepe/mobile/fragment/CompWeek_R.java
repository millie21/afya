...
public class CompWeek_R extends Fragment {
    ...
    private static String url = "http://192.168.2.196/afyapepe3/public/showmanucompetitionregionweek";
    ...
    public void onStart() {
        ...
        new CompWeek_R.GetAllJobs().execute();
    }
