...
/**
 * Created by Millie Agallo on 11/23/2017.
 */

public class ManuByPharmacy50 extends AppCompatActivity {
    ...
    public  void onCreate(Bundle savedInstanceState) {
        ...
        db = new SQLiteHandler(ManuByPharmacy50.this);

        session = new SessionManager(ManuByPharmacy50.this);
...
//        });
        ...
        adapter = new SimpleSalesAdapter(ManuByPharmacy50.this, salesList);
        listView.setAdapter(adapter);

        pDialog = new ProgressDialog(ManuByPharmacy50.this);

        pDialog.setMessage("Loading...");
        pDialog.setCancelable(false);
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.manubypharm50_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ManuByPharmacy50.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
...
//                                * and any View reflecting the data set should refresh itself.
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ManuByPharmacy50.this, error.toString(), Toast.LENGTH_LONG).show();
