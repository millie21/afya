...
public class CompMonth_D extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, App_Config.compmonth_d_url,
...
//                                * and any View reflecting the data set should refresh itself.
        ...
        //tot
        StringRequest stringRequestb = new StringRequest(Request.Method.POST, App_Config.comp_month_d_total,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d(TAG, response.toString());
